...
Tambi'en se ampli'o el concepto de heterogeneidad al permitir soportar secuentes heterogeneos. De esta forma el an'alisis se volvi'o m'as sencillo \todomm{No entiendo esta oración…}al introducir un mayor nivel de abstracci'on sobre los lenguajes aceptados por el sistema. Adem'as se incorporaron herramientas y acciones para traducir, seleccionar o combinar \todomm{¿cómo se pueden combinar?} las f'ormulas dentro de un secuente dado.
...
Por 'ultimo se evaluaron las herramientas autom'aticas integradas sobre un conjunto de lemas de XXX\todomm{cambiar}, mostrando cuales son los casos donde 'estas herramientas logran mejores o peores resultados.\todomm{poner en una frase lo más importante de los resultados empíricos. Algo parecido a lo que está al final del capítlulo anterior.}
