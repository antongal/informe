...
\todomm{Parrafo siguiente: Esto se puede usar como la reseña histórica que te mencionaba más arriba (en el capítulo anterior). Si la vas a usar, hay que sacarla de acá y hacer referencia a ella. Algo como: “Tal como se mencionó en el capítulo anterior, la competencia CASC ha adquirido una gran reputación en los últimos años”.}
...
\todomm{En el capítulo anterior se dijo que las reglas se leen de manera inversa a como se leen aquí.}
