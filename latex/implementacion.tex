...
\todomm{Respetar márgenes. Poner figuras apaisadas en hojas aparte si es necesario.}
\begin{figure}[H]
...
Sea \todomm{Usar la misma notación que se usó en el capítulo 2 para explicar el cálculo de secuentes}$\{\alpha_1 \dots \alpha_n\} \Rightarrow \{\beta_1 \dots \beta_m\}$ el secuente bajo an'alisis.
