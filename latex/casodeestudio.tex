...
\todomm{mostrar sólo el árbol y el secuente}
\begin{figure}[H]
...
\todomm{Esta tabla no dá información. Sacarla y en su lugar poner el código alloy de las fórmulas evaluadas, como para que el lector sepa el tipo de fórmulas con los que estuvimos trabajando.
Luego de eso, mencionar la lista de los lemas que pudieron ser demostrados automáticamente.}
\vspace{1em}
